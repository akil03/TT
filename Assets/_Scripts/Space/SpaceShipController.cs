...
public class SpaceShipController : MonoBehaviour {
	...
	void Update () {
        ...
        if (!isGameOver)
        {
            ...
            Engine.pitch = Mathf.Lerp(Engine.pitch, Mathf.Clamp(1.2f + (Mathf.Abs(player.transform.rotation.eulerAngles.x - playerPivot.transform.rotation.eulerAngles.x)/40),1.2f,2.2f),Time.deltaTime);
